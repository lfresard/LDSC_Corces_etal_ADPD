...
#Idr Optimal Peaks
for x in LAMP5_Interneurons Parvalbumin_Interneurons Somatostatin_Interneurons Striatal_Interneurons Striatopallidal_MediumSpinyNeurons vGLUT2neg_ExcitatoryNeurons VIPIP_Interneurons; do
	echo "Processing ${x}"
...
#Idr Optimal Peaks
for x in C10 C12 NeuronC13 NeuronC14 NeuronC15 NeuronC17 NeuronC18 NeuronC19 NeuronC20 NeuronC21 NeuronC24 NeuronC25 NeuronC26 NeuronC27 NeuronC28 NeuronC29 NeuronC2 NeuronC30 NeuronC3 NeuronC6 NeuronC7 NeuronC8 NeuronC9; do
	echo "Processing ${x}"
